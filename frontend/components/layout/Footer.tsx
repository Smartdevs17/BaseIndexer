      ...
      <div className="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8">
            ...
            <p className="text-sm leading-6 text-gray-600 dark:text-gray-400">
              AI-powered blockchain indexer for the Base ecosystem. Explore transactions, analyze data, 
              and interact with blockchain information using natural language queries.
            </p>
        ...
        <div className="mt-16 border-t border-gray-900/10 dark:border-gray-700 pt-8 flex flex-col sm:flex-row justify-between items-center">
          <p className="text-xs leading-5 text-gray-500 dark:text-gray-400">
            &copy; {currentYear} BaseIndexer. All rights reserved.
          </p>
